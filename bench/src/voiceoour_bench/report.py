"""Report generation for VoiceOour benchmark runner outputs."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build a VoiceOour benchmark report from runner JSONL output.")
