"""Dataset preparation for VoiceOour benchmark tiers."""
...
SMOKE_UTTERANCES: tuple[tuple[str, str], ...] = (
    ...
    ("proper_noun_voiceoour", "VoiceOour should paste this into Notes."),
...
TECHTERMS_CASES: tuple[dict[str, Any], ...] = (
    ...
    {
        "slug": "voiceoour",
        "reference": "VoiceOour should preserve the selected microphone.",
        "canonical_term": "VoiceOour",
        "term_id": "term-voiceoour",
        "term_class": "coinage",
        "expect_term": True,
        "hard_negative_kind": None,
        "project_scope": "voiceoour",
    },
    {
        "slug": "c_language",
