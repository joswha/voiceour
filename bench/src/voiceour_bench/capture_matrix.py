...
def plan_matrix(
    ...
    output_dir: Path,
    *,
    executable: str | Path = "voiceour-capture-bench",
...
def _add_plan_arguments(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--executable", default="voiceour-capture-bench")
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Plan and collect the Voiceour paired capture matrix.")
