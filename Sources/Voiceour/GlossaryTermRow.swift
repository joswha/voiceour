...
struct GlossaryTermRow: View {
    ...
    var body: some View {
        ...
        .background {
            Rectangle()
                .fill(isHoveringRow ? VoiceourPalette.Plate.hover : Color.clear)
        }
        .contentShape(Rectangle())
        .onHover { isHoveringRow = $0 }
        .animation(a11y.reduceMotion ? nil : VoiceourMotion.quick, value: isHoveringRow)
    }
    ...
    private var aliasCell: some View {
        TextField("No alternate detections", text: $aliasText)
            ...
            .foregroundStyle(VoiceourPalette.Text.mono)
            ...
            .overlay {
                RoundedRectangle(cornerRadius: aliasRadius, style: .continuous)
                    .strokeBorder(
                        aliasFieldFocused ? VoiceourPalette.Line.focus : Color.clear,
            ...
            .animation(a11y.reduceMotion ? nil : VoiceourMotion.quick, value: aliasFieldFocused)
            .animation(a11y.reduceMotion ? nil : VoiceourMotion.quick, value: isHoveringAlias)
            .onSubmit {
    ...
    private var aliasFill: Color {
        ...
        return isHoveringAlias ? VoiceourPalette.Plate.hover : Color.clear
    }
