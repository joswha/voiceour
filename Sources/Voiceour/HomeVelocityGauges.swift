...
struct VelocityGauges: View {
    ...
    private static let labelWidth = VoiceourMetrics.Space.section + VoiceourMetrics.Space.xl
    ...
    private static let valueWidth = VoiceourMetrics.Field.short
    private static let fieldWidth = VoiceourMetrics.Space.section + VoiceourMetrics.Space.xl
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: VoiceourMetrics.Space.sm) {
            ...
            gaugeRow(label: "TYPING", fill: VoiceourPalette.Meter.rest, fraction: typingFraction) {
                typingField
            }
