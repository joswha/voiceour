    ...
    private func ompOnboardingDetail(
        ...
        case .terminalOpen:
            let detail =
                ...
                + "Voiceour is waiting for OMP to return."
            return (detail, false)
        case .signedIn(_, _, let detail):
            return (detail, false)
        case .cancelled:
            return ("The OMP sign-in was cancelled; Voiceour created no credential.", false)
...
/// group of six when Voiceour spoke to four cloud vendors itself.
