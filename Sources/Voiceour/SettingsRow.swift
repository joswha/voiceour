    ...
    var body: some View {
        HStack(alignment: .top, spacing: VoiceourMetrics.Space.xl) {
            Text(label)
                ...
                .recordTextRole(.label, foreground: VoiceourPalette.Text.high)
        ...
        .frame(
            maxWidth: .infinity,
            minHeight: VoiceourMetrics.Row.settings,
            alignment: .leading
        )
...
private struct SettingsStatusButton: View {
    ...
    private var stroke: Color {
        ...
        return isHovered ? VoiceourPalette.Line.controlHover : a11y.lineControl
    }
}
