...
enum GlossaryColumn {
    static let canonical = VoiceOourMetrics.Column.glossaryCanonical
    static let aliases = VoiceOourMetrics.Column.glossaryAliases
    static let policy = VoiceOourMetrics.Column.glossaryPolicy
    static let action = VoiceOourMetrics.Column.rowAction
    ...
    static let inner = VoiceOourMetrics.Content.table - VoiceOourMetrics.Space.md * 2
    ...
    static let textInset = VoiceOourMetrics.Space.xs
    ...
    static func scope(policy showsPolicy: Bool) -> CGFloat {
        ...
        return max(inner - fixed - gutters, VoiceOourMetrics.Column.glossaryScopeMin)
    }
...
extension View {
    func glossaryBand(
        height: CGFloat = VoiceOourMetrics.Row.table,
