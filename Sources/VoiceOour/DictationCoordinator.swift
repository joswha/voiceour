    ...
    public static func live() -> DictationCoordinator {
        Task.detached(priority: .utility) {
            RecordingScavenger.sweep(
                directory: FileManager.default.temporaryDirectory.appendingPathComponent("voiceoour")
            )
        }
        ...
        let backend =
            ...
            ?? VoiceCore.LaunchOptions.validBackend(env["VOICEOOUR_ASR_BACKEND"], validBackendIDs: registry.backendIDs)
