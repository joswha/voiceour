...
struct SectionHeader: View {
    ...
    private func refreshGrants(animated: Bool) {
        ...
        withAnimation(VoiceOourMotion.deliberate) {
            microphone = permissions.microphone()
            synthPaste = permissions.synthPaste()
            accessibility = permissions.accessibility()
        }
    ...
    private var trailing: some View {
        ...
        case .silent:
            Text(verbatim: " ")
                .roleStyle(.micro)
                .hidden()
                .frame(width: 0, height: VoiceOourMetrics.Control.mini)
        }
    }
    ...
    var body: some View {
        HStack(alignment: .firstTextBaseline, spacing: VoiceOourMetrics.Space.xl) {
            ...
            Spacer(minLength: VoiceOourMetrics.Space.lg)
        ...
        .padding(.bottom, VoiceOourMetrics.Space.xl)
