...
final class RecordingOverlayController: NSObject, NSWindowDelegate {
    ...
    private func show() {
        ...
        NSAnimationContext.runAnimationGroup { context in
            context.duration = VoiceOourMotion.standardDuration
...
private enum RecordingOverlayDefaults {
    static let originXKey = "VoiceOour.RecordingOverlay.origin.x"
    static let originYKey = "VoiceOour.RecordingOverlay.origin.y"
}
