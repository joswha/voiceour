...
/// Shared design vocabulary for VoiceOour's glass console and recording overlay.
...
enum TextRole {
    ...
    var font: Font {
        switch self {
        case .heroMetric: VoiceOourTypography.heroMetric
        case .metric: VoiceOourTypography.metric
        case .tileValue: VoiceOourTypography.tileValue
        case .title: VoiceOourTypography.title
        case .label: VoiceOourTypography.label
        case .body: VoiceOourTypography.body
        case .bodyMono: VoiceOourTypography.bodyMono
        case .caption: VoiceOourTypography.caption
        case .eyebrow: VoiceOourTypography.eyebrow
        case .micro: VoiceOourTypography.micro
        case .emptyGlyph: VoiceOourTypography.emptyGlyph
        }
    }
    ...
    var foreground: Color {
        ...
        case .tileValue:
            VoiceOourPalette.Text.monoStrong
        case .bodyMono:
            VoiceOourPalette.Text.mono
        case .caption, .eyebrow, .micro:
            VoiceOourPalette.Text.low
        case .emptyGlyph:
            VoiceOourPalette.Mark.faint
        }
    }
}
