...
4. **History** — search, day-grouped transcripts, and the selected transcript opened inside its own day group as a buttonless well the reader clicks to copy and selects from to teach.
