...
Benchmarked against Parakeet on this hardware (2026-07-17, identical scorer, M4 Pro): LibriSpeech n=64 U-WER 3.07% vs 2.84% (Parakeet better), FLEURS n=8 U-WER 3.85% vs 4.49% and punctuation micro-F1 0.86 vs 0.79 (Apple better), tech-vocabulary TTS set 17/26 vs 18/26 term hits (parity). Batch latency: Apple ASR p95 885ms flat even on 35s audio vs Parakeet's 2327ms tail. `mlx` remains the default backend.
