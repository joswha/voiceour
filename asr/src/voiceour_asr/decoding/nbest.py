...
:class:`~voiceour_asr.decoding.trie.PhraseTrie` bias is supplied (opt-in),
...
from voiceour_asr.decoding import text_from_tokens
...
class NBestParakeetTDT(ParakeetTDT):
    ...
    def decode_beam_nbest(
        ...
        *,
        ...
        ``bias`` is a :class:`~voiceour_asr.decoding.trie.PhraseTrie`, its
    ...
    def generate_nbest(
        ...
        *,
        ...
        :class:`~voiceour_asr.decoding.trie.PhraseTrie` is forwarded to
