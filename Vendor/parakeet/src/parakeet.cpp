...
static struct ggml_cgraph * parakeet_build_graph_encode(parakeet_context & pctx, parakeet_state & pstate) {
    ...
    struct ggml_tensor * cur = parakeet_conv_2d_bias(ctx0, model.enc_pre_conv_0_w, mel,
            model.enc_pre_conv_0_b, 2, 2, 1, 1, 1, 1);
